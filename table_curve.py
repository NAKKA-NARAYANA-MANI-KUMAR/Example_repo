...
class PrescriptionPage(PrescriptionOnlyTemplate):
    ...
    def _build_styled_table(self, table_data, col_widths) -> Table:
        """Build a styled table with all corners rounded (for page-wise rendering)."""
        ...
        style = [
            ...
            # Rounded all corners for every chunk
    ...
    def _create_prescription_table(self, medications: list) -> Table:
        ...
        return self.build_prescription_tables_per_page(table_data, col_widths)
